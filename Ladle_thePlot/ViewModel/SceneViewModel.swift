...
struct SceneViewModel {
    var scenesStorage :[RecipeScene] = [
        ...
        RecipeScene(name: "The dough has to growth", recipeName: "pizza", sceneNumber: 4, steps: ["Now the dough has to grow! Put a linen on the ipad and when you here a sound it means that the dough is ready."], stepIngredients: nil, alternativeStepsIngredient: nil, container: "doughBeforeLeavening", finalResult: "doughAfterLeavening"), // when there is the leavening, use the scale effect
        
        RecipeScene(name: "Crush the dough to roll out the dough", recipeName: "pizza", sceneNumber: 5, steps: ["Crush the dough in order to obtain the pizza base!"], stepIngredients: nil, alternativeStepsIngredient: nil, container: "dough", finalResult: "pizzadough"),
        
        
        RecipeScene(name: "Add the ingredients for the seasoning", recipeName: "pizza", sceneNumber: 6, steps: ["Add the pomodoro sauce!", "Add the salt!", "Add the oil!"], stepIngredients: ["pomodoro sauce", "salt", "olive oil"], alternativeStepsIngredient: nil, container: "emptyBowl", finalResult: "pomodorosauce"),
        
        RecipeScene(name: "Spread the seasoning", recipeName: "pizza", sceneNumber: 7, steps: ["Spread the seasoning!"], stepIngredients: ["pomodoro sauce"], alternativeStepsIngredient: nil, container: "pizzadough", finalResult: "emptypizza"),
        
        RecipeScene(name: "Add mozzarella", recipeName: "pizza", sceneNumber: 8, steps: ["Add mozzarella!"], stepIngredients: ["mozzarella"], alternativeStepsIngredient: nil, container: "emptypizza", finalResult: "rawpizza"),
