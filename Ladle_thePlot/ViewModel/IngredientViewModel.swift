...
struct IngredientViewModel {
    ...
    var ingredientsStore : [Ingredient] = [
        ...
        Ingredient(name: "Strawberries", image: "strawberry", droppedImage: nil, quantity: "50g", recipeName: "ice cream", isAlternative: false),
        Ingredient(name: "Banana", image: "banana", droppedImage: nil, quantity: "50g", recipeName: "ice cream", isAlternative: false),
