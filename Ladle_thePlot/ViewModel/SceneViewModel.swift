...
struct SceneViewModel {
    var scenesStorage :[RecipeScene] = [
        ...
        RecipeScene(name: "Crush the dough", recipeName: "pizza", sceneNumber: 4, steps: ["Crush the dough by tapping it!"], stepIngredients: nil, alternativeStepsIngredient: nil, container: "dough", finalResult: nil),
