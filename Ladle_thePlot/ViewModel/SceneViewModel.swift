...
struct SceneViewModel {
    var scenesStorage :[RecipeScene] = [
        ...
        RecipeScene(name: "Roll out the dough by moving the rolling pin!", recipeName: "pizza", sceneNumber: 6, steps: ["Roll out the dough in order to obtain the pizza base!"], stepIngredients: nil, alternativeStepsIngredient: nil, container: "dough", finalResult: "pizzadough"),
        ...
        RecipeScene(name: "Place the pizza in the oven", recipeName: "pizza", sceneNumber: 10, steps: ["Place it in the oven "], stepIngredients: nil, alternativeStepsIngredient: nil, container: "rawpizza", finalResult: "pizza1"),
        
        // for the ice cream
        RecipeScene(name: "Add the ingredients!", recipeName: "ice cream", sceneNumber: 1, steps: ["Add the condensed milk!", "Add the ice cubes", "Add strawberries", "Add banana"], stepIngredients: ["condensed milk", "ice cubes", "strawberries", "banana"], alternativeStepsIngredient: nil, container: "blender", finalResult: nil),
        ...
        RecipeScene(name: "Shake to use the blender", recipeName: "crepe", sceneNumber: 2, steps: ["Shake your iPad to blend the ingredients!"], stepIngredients: nil, alternativeStepsIngredient: nil, container: "blender", finalResult: "blendingredients")
