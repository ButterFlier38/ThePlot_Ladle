...
//                            drag gesture
                ...
                .frame(width: geometry.size.width - geometry.size.width/8, height: geometry.size.height/3.1, alignment: .trailing)
...
//                        .position(x: 250, y: 650)
                        ...
                        .overlay( Image("nuvoletta").scaleEffect(0.16).position(x: 510, y: 250))
                                    .overlay(Text("Keep on adding the ingredients to the blender, following the steps of the recipe.")
